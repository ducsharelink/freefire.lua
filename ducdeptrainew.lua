...
local Window = Fluent:CreateWindow({
    Title = "FREE FIRE HUB | DucDepTrai",
    SubTitle = "",
    TabWidth = 160,
...
ImageButton.Image = "http://www.roblox.com/asset/?id=80919268041563"
...
local function ChangeModeFastAttack(SelectFastAttackMode)
	...
	elseif SelectFastAttackMode == "Fast Attack" then
		FireCooldown = 0.01
	elseif SelectFastAttackMode == "1 Fast" then
		FireCooldown = 0.01
	end
end
